        ...
        <div class="col-lg-8 mb-4">
            <div class="card dashboard-card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-sm btn-primary" onclick="addTodo()">
                        ...
                        <div class="mb-3">
                            <div class="input-group" id="addTodoForm" style="display: none;">
                                <input type="text" class="form-control" id="todoInput" placeholder="Masukkan tugas baru..."
                                    maxlength="100">
                                <button class="btn" style="background-color:#F2F1ED;" onclick="saveTodo()">
                                    <i class="bi bi-check" style="color: #710014;"></i>
                                </button>
                                <button class="btn" style="background-color:#F2F1ED; border-left: 1px solid #710014;" onclick="cancelTodo()">
                                    <i class="bi bi-x" style="color: #710014;"></i>
                                </button>
                            </div>
                        </div>
                        <div id="todoList"></div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card dashboard-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.categories.index') }}" class="btn btn-sm btn-primary">Lihat Semua</a>
                </div>
                <div class="card-body p-4">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card dashboard-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.books.index') }}" class="btn btn-sm btn-primary">Lihat Semua</a>
                </div>
                <div class="card-body p-4">
